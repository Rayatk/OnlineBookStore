<!--# OnlineBookStore </a> Website Using Java -->
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri  > Paste The Repository Url as: ```https://github.com/Rayatk/onlinebookstore.git```> Select J2EE Branch > Next > Next > Finish
